...
//test.ReadTranslation();
document.getElementById("listenBtn").addEventListener("click", test.ReadTranslation())
...
///DOM
document.getElementById("myBtn").addEventListener("click", DisplayTranslation());
